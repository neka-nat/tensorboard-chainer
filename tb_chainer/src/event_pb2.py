...
from tb_chainer.src import summary_pb2 as tb__chainer_dot_src_dot_summary__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='tb_chainer/src/event.proto',
  package='tensorboard',
  syntax='proto3',
  ...
  ,
  dependencies=[tb__chainer_dot_src_dot_summary__pb2.DESCRIPTOR,])
...
_EVENT.fields_by_name['summary'].message_type = tb__chainer_dot_src_dot_summary__pb2._SUMMARY
...
Event = _reflection.GeneratedProtocolMessageType('Event', (_message.Message,), dict(
  DESCRIPTOR = _EVENT,
  __module__ = 'tb_chainer.src.event_pb2'
