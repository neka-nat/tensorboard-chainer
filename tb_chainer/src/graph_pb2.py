...
# source: tb_chainer/src/graph.proto
...
from tb_chainer.src import node_def_pb2 as tb__chainer_dot_src_dot_node__def__pb2
from tb_chainer.src import versions_pb2 as tb__chainer_dot_src_dot_versions__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='tb_chainer/src/graph.proto',
  package='tensorboard',
  syntax='proto3',
  ...
  ,
  dependencies=[tb__chainer_dot_src_dot_node__def__pb2.DESCRIPTOR,tb__chainer_dot_src_dot_versions__pb2.DESCRIPTOR,])
...
_GRAPHDEF.fields_by_name['node'].message_type = tb__chainer_dot_src_dot_node__def__pb2._NODEDEF
_GRAPHDEF.fields_by_name['versions'].message_type = tb__chainer_dot_src_dot_versions__pb2._VERSIONDEF
...
GraphDef = _reflection.GeneratedProtocolMessageType('GraphDef', (_message.Message,), dict(
  ...
  __module__ = 'tb_chainer.src.graph_pb2'
