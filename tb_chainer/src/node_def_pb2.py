...
# source: tb_chainer/src/node_def.proto
...
from tb_chainer.src import attr_value_pb2 as tb__chainer_dot_src_dot_attr__value__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='tb_chainer/src/node_def.proto',
  package='tensorboard',
  syntax='proto3',
  ...
  ,
  dependencies=[tb__chainer_dot_src_dot_attr__value__pb2.DESCRIPTOR,])
...
_NODEDEF_ATTRENTRY.fields_by_name['value'].message_type = tb__chainer_dot_src_dot_attr__value__pb2._ATTRVALUE
...
NodeDef = _reflection.GeneratedProtocolMessageType('NodeDef', (_message.Message,), dict(
  ...
  AttrEntry = _reflection.GeneratedProtocolMessageType('AttrEntry', (_message.Message,), dict(
    ...
    __module__ = 'tb_chainer.src.node_def_pb2'
