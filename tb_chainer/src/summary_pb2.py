...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tb_chainer/src/summary.proto',
  package='tensorboard',
  syntax='proto3',
  ...
  ,
  dependencies=[tb__chainer_dot_src_dot_tensor__pb2.DESCRIPTOR,])
...
_SUMMARY_VALUE.fields_by_name['tensor'].message_type = tb__chainer_dot_src_dot_tensor__pb2._TENSORPROTO
...
SummaryDescription = _reflection.GeneratedProtocolMessageType('SummaryDescription', (_message.Message,), dict(
  ...
  __module__ = 'tb_chainer.src.summary_pb2'
